...
echo $this->Html->css('/full_calendar/css/bootstrap.min');
echo $this->Html->css('/full_calendar/css/bootstrap');
echo $this->Html->css('/full_calendar/css/fullcalendar', null, array('inline' => false));

echo $this->Html->script(array('/full_calendar/js/jquery-1.5.min', '/full_calendar/js/jquery-ui-1.8.9.custom.min', '/full_calendar/js/fullcalendar.min', '/full_calendar/js/jquery.qtip-1.0.0-rc3.min', '/full_calendar/js/ready', '/full_calendar/js/bootstrap',  '/full_calendar/js/bootstrap.min'), array('inline' => 'false'));
