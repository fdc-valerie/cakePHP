...
<div class="container">
	<?php echo $this->Flash->render('positive') ?>
 	...
 	<form action ="/services/edit/<?php echo $service['id'] ?>" method="POST" class="form-horizontal" role="form">
		 	...
		 	<div class="form-group">
			  		...
			  		<div class="form-group">
						...
						<input type="input" class="form-control" name="data[Services][id]"  value="<?php echo $service['id'] ?>"/>
	 			  		...
	 			  		<label for="serv_name">Services Title</label>
						  	<select id="title" name="data[Service][title]" class ="form-control" value="<?php echo $service['title'] ?>"onclick="populate(this.id,'description')">					 
								<option value="<?php echo $service['title'] ?>"">Major Surgeries</option>
				...
				<div class="form-group">
					<div class="col-sm-4">
						<label for="serv_description">Service Description</label>
							<select id="description" name="data[Service][description]" class="form-control" value="<?php echo $service['description'] ?>">
							</select>
						</div>
				</div>
				...
				<div class="form-group">
					<div class="col-sm-4">
						...
						<input type="date" class="form-control" name="data[Service][date]" value="<?php echo $service['date'] ?>"/>
					</div>
				</div>
